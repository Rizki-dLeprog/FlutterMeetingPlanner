...
class _HowToUsePageState extends State<HowToUsePage> {
  ...
  final List<HowToUseCard> cards = [
    HowToUseCard(
      title: 'How to add company name',
      contents: [
        HowToUseStep(
            '1. Press the "+ Add" button located at the bottom of the homepage.',
            'assets/images/howtouse_images/htu_add_button.png'),
        HowToUseStep('2. Choose add company.',
            'assets/images/howtouse_images/htu_menu_option.png'),
        HowToUseStep(
    ...
    HowToUseCard(
      ...
      contents: [
        HowToUseStep(
            '1. Press the "+ Add" button located at the bottom of the homepage.',
            'assets/images/howtouse_images/htu_add_button.png'),
        HowToUseStep('2. Choose add meeting.',
            'assets/images/howtouse_images/htu_menu_option.png'),
        HowToUseStep(
            '3. Fill the columns and press “Add Meeting” to save the new meeting. If the company name list does not appear in the "Company Name" column, add the company name first!',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'How to Use'),
