...
import '../widgets/app_bar/home_appbar.dart';
import '../widgets/gradients/gradient_button.dart';
import '../widgets/other_components/add_bottom_menu.dart';
import '../widgets/other_components/custom_date_picker.dart';
import '../widgets/other_components/task_bottom_menu.dart';
import '../widgets/other_components/task_tile.dart';
...
class _HomePageState extends State<HomePage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: GradientButton(
          ...
          text: 'Add',
          onPressed: () async {
            showAddBottomMenu(context, _taskController);
          },
  ...
  void _showBottomSheet(BuildContext context, Task task) {
    showTaskBottomMenu(context, task, _taskController);
  }
}
