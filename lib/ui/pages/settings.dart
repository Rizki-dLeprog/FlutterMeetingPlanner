    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildCard(_buildListTile(
              'All meetings', 'assets/images/icon_images/activity_icon.svg',
              () async {
            await Get.to(() => const AllMeetingPage());
          })),
          _buildCard(_buildListTile(
              'How to use', 'assets/images/icon_images/question_icon.svg',
              () async {
            await Get.to(() => const HowToUsePage());
          })),
          _buildCard(_buildListTile(
              'App info', 'assets/images/icon_images/info_icon.svg', () async {
  ...
  Widget _buildSwitchListTile() {
    return ListTile(
      ...
      leading: SvgPicture.asset(
        _isMuted
            ? 'assets/images/icon_images/mute_icon.svg'
            : 'assets/images/icon_images/un_mute_icon.svg',
        color: primaryClr1,
        width: 24,
        height: 24,
      ),
