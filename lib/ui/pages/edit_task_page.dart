...
import '../widgets/other_components/custom_snackBar.dart';
import '../widgets/other_components/input_field.dart';
...
class _EditTaskPageState extends State<EditTaskPage> {
  ...
  void initState() {
    ...
    _noteController = TextEditingController(
        text: widget.task.note == '-' ? '' : widget.task.note);
          ...
          child: Column(
            ...
            children: [
              ...
              InputField(
                ...
                hintOpacity: _noteController.text.isEmpty ? 0.4 : 1.0,
              ),
              InputField(
                title: 'Date',
                hint: DateFormat('EEEE, d MMMM yyyy').format(_selectedDate),
